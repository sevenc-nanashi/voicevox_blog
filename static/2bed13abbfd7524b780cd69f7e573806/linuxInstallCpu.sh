...
curl -fsSL https://raw.githubusercontent.com/Hiroshiba/voicevox/0.7.5/build/installer_linux.sh >tmp_voicevox_installer.sh
VERSION=0.7.5 NAME=linux-cpu-appimage bash tmp_voicevox_installer.sh
